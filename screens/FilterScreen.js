                ...
                />
                    ...
                    <View>
                      <CheckBox
                            center
                            title='Equi 2'
                            checked={this.state.isChecked21}
                            onPress={() => this.setState({isChecked21: !this.state.isChecked21})}
                    ...
                    <View>
                      <CheckBox
                            center
                            title='Resource 4'
                            checked={this.state.isChecked41}
                            onPress={() => this.setState({isChecked41: !this.state.isChecked41})}
                    ...
                    <View>
                      <CheckBox
                            center
                            title='Dept 3'
                            checked={this.state.isChecked31}
                            onPress={() => this.setState({isChecked31: !this.state.isChecked31})}
                    ...
                    <View>
                      <CheckBox
                            center
                            title='2151 S'
                            checked={this.state.isChecked22}
                            onPress={() => this.setState({isChecked22: !this.state.isChecked22})}
